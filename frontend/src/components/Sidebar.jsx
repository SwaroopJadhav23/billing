...
import { BarChart3, ChefHat, ClipboardList, CreditCard, LayoutDashboard, Package, ReceiptText, Settings, ShoppingCart, Table2, Users, WalletCards, X } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/kot', label: 'Kitchen KOT', icon: ChefHat },
...
export default function Sidebar({ open, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed inset-y-0 left-0 z-40 w-72 -translate-x-full border-r border-slate-200 bg-white p-4 transition lg:static lg:translate-x-0 dark:border-slate-800 dark:bg-slate-950 ${open ? 'translate-x-0' : ''}`}>
