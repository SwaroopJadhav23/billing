...
export default function Topbar({ onMenu }) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-slate-50/85 px-4 py-3 backdrop-blur dark:border-slate-800 dark:bg-slate-950/85 lg:px-8">
      <div className="flex items-center justify-between gap-4">
        <button className="btn-muted lg:hidden" onClick={onMenu}><Menu size={18} /></button>
        <div>
